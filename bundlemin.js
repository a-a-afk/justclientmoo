! function (e) {
    ...
    function rn() {
        onMobile ? setTimeout((function () {
            var e = prompt("chat message");
            e && sendMessage(e)
        }), 1) : "block" == nn.style.display ? (tn.value && sendMessage(tn.value), an()) : (Qe.style.display = "none", Ye.style.display = "none", nn.style.display = "block", tn.focus(), yn()), tn.value = ""
    }
    ...
    var onMobile, cn, ln = ["cunt", "whore", "fuck", "shit", "faggot", "nigger", "nigga", "dick", "vagina", "minge", "cock", "rape", "cum", "sex", "tits", "penis", "clit", "pussy", "meatcurtain", "jizz", "prune", "douche", "wanker", "damn", "bitch", "dick", "fag", "bastard"];
    ...
    function fn(e) {
        (onMobile = e) ? Ae.classList.add("touch"): Ae.classList.remove("touch")
    }
    ...
    function pn() {
        return R ? (-1 != se.id ? cn = Math.atan2(se.currentY - se.startY, se.currentX - se.startX) : R.lockDir || onMobile || (cn = Math.atan2(ie - z / 2, ne - F / 2)), s.fixTo(cn || 0, 2)) : 0
    }
